...
//var ivc_url= "https://ivc.ischool.utexas.edu/VizWiz_v2/Images/";
var imageList= ["https://utexas.app.box.com/s/z933jcs6d69d3m4x4yvhkyaikcpnzndu"];
/*var text_list= ["Suggest a wallpaper of Lord Buddha for the wall shown in the picture",
                "Suggest a wall clock that is green in color with a pendulum having alarm sound",
                "Suggest a white flower vase to be kept on the middle of the table",
                "Suggest a blue color floor mat that should match with the wall"];*/
for(i in imageList){

// var image_name = imageList[i];
var image_url = imageList[i];
//var text_value = text_list[i];
console.log(image_url);


const myQuestion = `<?xml version="1.0" encoding="UTF-8"?>
<ExternalQuestion xmlns="http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2006-07-14/ExternalQuestion.xsd">
    <ExternalURL>https://compviz-secondary.z13.web.core.windows.net/demo.html?image=${image_url}</ExternalURL>
